...
from gameserver.misc.models import AccountLoginRequest, ItemRequest, GameSessionData, ShopItemList, ShopItem
...
def test_validate():
    # game_session_data_json = '{"data": {"account_uuid": "099e9d9c79c54a2397c8904ad903e833", "nickname": "nick", "balance": 13.52, "session_uuid": "5572db08071748bca85924bbf2cbc3fe", "owned_items": [{"uuid": "1f1ecd78d8ef4067979b38b9a4be33ee", "name": "Sampson", "price": 24, "type": "ship"}, {"uuid": "1cd5dc973a2f48b19c170558d7c4550e", "name": "garbage can", "price": 43, "type": "equipment"}]}}'
    ...
    shop_item_list_json = '[{"uuid": "1f1ecd78d8ef4067979b38b9a4be33ee", "name": "Sampson", "price": 24, "type": "ship"}]'
