...
class BadRequest(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Bad Request", 1000, value)


class Unathorized(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Unathorized", 1001, value)


class UnknownActionType(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Unknown action type", 1002, value)


class UnknownServerError(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Unknown error on server has happened", 1003, value)
...
class AccountAlreadyExists(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Account with this nickname already exists", 1051, value)


class AccountNotExist(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Account doesn't exist", 1052, value)
...
class AccountBalanceNotFound(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Failed to find account balance record", 1151, value)


class NotEnoughFundsInAccountBalance(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Not enough funds on account", 1152, value)
...
class ShopItemNotFound(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Not found shop item", 1201, value)
...
class AccountAlreadyOwnsItem(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Account already has this item", 1251, value)


class AccountDoesntOwnItem(BaseGameServerException):
    def __init__(self, value: Optional[str] = None):
        super().__init__("Account doesn't have this item", 1252, value)
